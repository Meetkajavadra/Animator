class Global {
  static List<Map> planetDetails = [
    {
      'name': 'Mercury',
      'galaxy': 'Milky Way Galaxy',
      'dist_from_earth': '143.09 Million KM From Earth',
      'overview':
      "Mercury is the smallest planet in our solar system. It's a little bigger than Earth's Moon. It is the closest planet to the Sun, but it's actually not the hottest. Venus is hotter. Along with Venus, Earth, and Mars, Mercury is one of the rocky planets.",
      'image': 'assets/images/mercury.png',
    },
    {
      'name': 'Venus',
      'galaxy': 'Milky Way Galaxy',
      'dist_from_earth': '256.41 Million KM From Earth',
      'overview':
    ...
    },
    {
      'name': 'Earth',
      'galaxy': 'Milky Way Galaxy',
      'dist_from_earth': '0 From Earth',
      'overview':
      "Our home planet is the third planet from the Sun, and the only place we know of so far that’s inhabited by living things.With a radius of 3,959 miles, Earth is the fifth largest planet in our solar system, and it's the only one known for sure to have liquid water on its surface.",
      'image': 'assets/images/earth.png',
    },
    {
      'name': 'Mars',
      'galaxy': 'Milky Way Galaxy',
      'dist_from_earth': '111.82 Million KM From Earth',
      'overview':
    ...
    },
    {
      'name': 'Jupiter',
      'galaxy': 'Milky Way Galaxy',
      'dist_from_earth': '595.01 Million KM From Earth',
      'overview':
      "Jupiter, Fifth planet from the Sun, the largest nonstellar object in the solar system. It has 318 times the mass and more than 1,400 times the volume of Earth. Its enormous mass gives it nearly 2.5 times the gravity of Earth (measured at the top of Jupiter’s atmosphere), and it exerts strong effects on other members of the solar system.",
      'image': 'assets/images/jupiter.png',
    },
    {
      'name': 'Saturn',
      'galaxy': 'Milky Way Galaxy',
      'dist_from_earth': '1.3846 Billion KM From Earth',
      'overview':
    ...
    },
    {
      'name': 'Uranus',
      'galaxy': 'Milky Way Galaxy',
      'dist_from_earth': '2.8169 Billion KM From Earth',
      'overview':
    ...
    },
    {
      'name': 'Neptune',
      'galaxy': 'Milky Way Galaxy',
      'dist_from_earth': '4.3348 Billion KM From Earth',
      'overview':
      ...
      'image': 'assets/images/naptune.png',
    },
  ];
}